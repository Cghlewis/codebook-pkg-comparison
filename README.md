I started this table as a way to compare existing r packages that assist in Codebook creation. The criteria I am looking for include the following variable level metrics:
